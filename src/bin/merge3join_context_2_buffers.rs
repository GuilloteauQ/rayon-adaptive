...
use rayon_adaptive::adaptive_sort_join_context3;
...
fn main() {
    ...
    #[cfg(feature = "logs")]
    {
        ...
        let (_, log) = pool.logging_install(|| {
            adaptive_sort_join_context3(&mut shuffled, block_size, block_size_fuse)
        });

        log.save_svg("merge_sort_join_context3_par_fuse.svg")
